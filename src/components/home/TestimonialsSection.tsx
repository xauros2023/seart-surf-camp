  ...
  return (
    <section className="section-shell overflow-hidden">
      <div className="mb-12 flex flex-col gap-6 sm:flex-row sm:items-end sm:justify-between">
        <div>
          <SectionReveal>
            <p className="section-kicker">Loved by travelers</p>
          </SectionReveal>
          <SectionReveal delay={0.1}>
            <h2 className="section-title text-balance">
              What people say <span className="font-serif italic text-terracotta">after they leave.</span>
            </h2>
          </SectionReveal>
        </div>
        ...
        >
          {testimonials.map((t, i) => (
            ...
            >
              <Quote
                aria-hidden="true"
                className="absolute right-7 top-7 text-terracotta/15 transition-colors duration-500 group-hover:text-terracotta/30"
                size={48}
              />
              ...
              <div className="mt-8 flex items-center gap-4 border-t border-foreground/[0.08] pt-6">
                ...
                <div className="min-w-0">
                  ...
                  <p className="truncate text-xs text-foreground/55">
                    {t.origin} · <span className="text-foreground/40">{t.source}</span>
                  </p>
                </div>
              </div>
            </motion.article>
