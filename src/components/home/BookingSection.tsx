          ...
          <div className="grid gap-5">
            <div className="glass-card p-7">
              <div className="flex items-start gap-5">
                ...
                <div>
                  <h2 className="font-serif text-2xl font-medium tracking-tight">Our location</h2>
            ...
            >
              ...
              <div className="absolute inset-x-0 bottom-0 p-7 text-white">
                <p className="text-[10px] font-medium uppercase tracking-[0.28em] text-sunset">Banana Beach access</p>
                <h3 className="mt-3 font-serif text-3xl font-medium tracking-tight">
                  Tamraght, <span className="italic">minutes from the breaks.</span>
                </h3>
                <a
